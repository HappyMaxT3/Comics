...
namespace Main
{
    public class FallOnDeath : MonoBehaviour
    {
        ...
        private void Fall()
        {
            //включаем симул€цию физики дл€ RigidBody2D
            _body.bodyType = RigidbodyType2D.Dynamic;
            //включаем непрерывную проверку коллизий чтобы объект никуда не проваливалс€
            _body.collisionDetectionMode = CollisionDetectionMode2D.Continuous;
            //включаем интерпол€цию чтобы объект падал максимально плавно
